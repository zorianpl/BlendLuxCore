...
from . import (
    ...
    exit, frame_change_pre, load_post, render_complete,
)
...
def register():
    ...
    bpy.app.handlers.render_cancel.append(render_complete.handler)
...
def unregister():
    ...
    bpy.app.handlers.render_cancel.remove(render_complete.handler)
